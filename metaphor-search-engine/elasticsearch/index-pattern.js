...
async function run() {
  ...
  const body = dataset.flatMap(doc => [{ index: { _index: 'sinhala-metaphor-songs' } }, doc])
  ...
  const { body: count } = await client.count({ index: 'sinhala-metaphor-songs' })
  console.log(count)
}
